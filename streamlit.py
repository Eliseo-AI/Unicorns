...
fig5 = px.scatter_geo(animated_data, lat='lat', lon='lng', size='value', color='city', animation_frame='year', hover_name='city', hover_data=['id_city', 'population', 'value'], projection='natural earth')
