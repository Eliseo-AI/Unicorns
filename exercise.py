...
fig4 = px.bar(pd.DataFrame.from_dict(investors_filtered, orient='index', columns=['count']).reset_index(), x='count', y='index', color='selected_investors', labels={'count':'Total Unicorns','index': 'Fund Investor'})
